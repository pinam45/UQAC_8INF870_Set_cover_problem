...
\begin{document}
	...
	\section{Conclusion}
		\paragraph*{}
			...
			choisir est une difficulté non négligible. Nous avons utilisé un logiciel d'optimisation de boîte noire pour nous aider
			à trouver de bons paramètres, mais cela prend alors plus de temps, et nous n'avons pas pu trouver de paramètres bons dans
			tous les cas. Les paramètres obtimaux semblent varier grandement selon le problème considéré.
