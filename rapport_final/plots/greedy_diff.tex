...
\begin{tikzpicture}
	\begin{axis}[
		...
		\addplot[unbounded coords=jump,smooth,color=blue,mark=*] table{plots/wgreedy_diff.data};
		\addlegendentry{Weighted Greedy}
		\addplot[unbounded coords=jump,smooth,color=red,mark=*] table{plots/ugreedy_diff.data};
