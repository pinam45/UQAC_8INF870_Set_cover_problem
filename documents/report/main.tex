...
\begin{document}
	...
	\newpage\section{Exemple minimal}
		...
		\begin{figure}[H]
			\centering%
			\includegraphics[width=0.65\linewidth]{scp_example}%
		...
		\subsection{Instances générées}\label{sec:generated-instances}
			...
			\begin{table}[H]
				...
				\begin{minipage}[t]{0.3\linewidth}
					\centering
					\input{../tables/generated_scp_problems_optimal_solutions_3_1}
				\end{minipage}
				\begin{minipage}[t]{0.3\linewidth}
					\centering
					\input{../tables/generated_scp_problems_optimal_solutions_3_2}
				\end{minipage}
				\begin{minipage}[t]{0.3\linewidth}
					\centering
					\input{../tables/generated_scp_problems_optimal_solutions_3_3}
				\end{minipage}
	...
	\section{Méthodes approchées}
		...
		\subsection{Méta-heuristiques}
			...
			\subsubsection{Algorithme génétique}
				\paragraph*{}
					Nous avons également implémenté un algorithme génétique qui utilise une sélection par rang ainsi qu'une recherche locale
		...
		\subsection{Analyse des méthodes approchées appliquées aux problèmes d'OR-Library}
			\paragraph*{}
				Pour évaluer les méthodes approchées développées, nous avons utiliser les problèmes d'OR-Library.
