\begin{tikzpicture}
	\begin{axis}[
		...
		\addplot[smooth,color=blue,mark=square*] table{g1_time.data};
		\addlegendentry{G1: ram expensive generator}
		\addplot[smooth,color=red,mark=*] table{g2_time.data};
		...
		\addplot[smooth,color=cyan,mark=triangle*] table{g3_time.data};
